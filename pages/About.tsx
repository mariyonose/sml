  ...
  useEffect(() => {
    if (isInView) {
      const controls = animate(motionValue, value, { 
        duration: 2, 
        ease: [0.16, 1, 0.3, 1], // Custom ease out expo for smoothness
      });
        ...
        <main className="w-full md:w-[60%] lg:w-[65%] bg-white overflow-x-hidden">
          ...
          <section className="px-8 md:px-16 lg:px-24 py-24 md:py-32">
            <div className="max-w-4xl">
              ...
              <div className="relative py-32 mb-32">
                ...
                <div className="absolute top-0 right-0 w-[70%] h-full bg-slate-50 -z-10 rounded-sm"></div>
                  ...
                  <div className="space-y-10 max-w-3xl">
                    {[
                      ...
                      <div key={i} className="flex gap-8 group items-start">
                        <div className="w-12 h-12 rounded-full border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-brand-blue group-hover:bg-brand-blue/5 transition-all duration-500">
                          <CheckCircle2 className="w-6 h-6 text-slate-400 group-hover:text-brand-blue transition-colors" />
                        </div>
                        <div className="pt-2">
              ...
              {/* Our Mission */}
              <div className="relative pt-4 pb-16 mb-24">
                {/* Offset background block */}
                <div className="absolute top-0 left-0 w-[70%] h-full bg-slate-50 -z-10 rounded-sm"></div>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 tracking-tight break-keep">
                    「医療の質で選ばれる日本」を実現する
                  </h3>

                  <p className="text-xl text-slate-600 leading-relaxed max-w-2xl break-keep">
              ...
              <div className="mb-24 overflow-x-auto">
                <div className="min-w-[800px] lg:min-w-0">
                  {/* Connection Diagram */}
                  <div className="relative flex items-stretch justify-between gap-4 mb-12">
                    ...
                    <div className="w-[30%] bg-white border border-slate-200 p-6 text-center flex flex-col items-center">
                      ...
                      <h4 className="font-bold text-slate-900 mb-4">提携クリニック</h4>
                    ...
                    <div className="w-[36%] bg-white border-2 border-[#b4975a] p-6 text-center flex flex-col items-center shadow-lg relative z-10">
                      ...
                      <h4 className="font-bold text-[#0f172a] mb-4">SSF Medical Link</h4>
                    ...
                    <div className="w-[30%] bg-white border border-slate-200 p-6 text-center flex flex-col items-center">
                      ...
                      <h4 className="font-bold text-slate-900 mb-4">海外エージェント<br />& 患者様</h4>
                      <div className="space-y-1 text-[11px] text-slate-500">
                        <p>日本医療へのアクセス</p>
                        <p>安心・安全な治療体験</p>
                        <p>適正な価格</p>
              ...
              <div className="grid grid-cols-1 gap-12 mb-32">
                <div className="flex gap-8 group">
                  <div className="text-4xl font-serif text-slate-200 group-hover:text-brand-blue transition-colors duration-500">01</div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-4">医療品質の担保</h3>
                ...
                <div className="flex gap-8 group">
                  <div className="text-4xl font-serif text-slate-200 group-hover:text-brand-blue transition-colors duration-500">02</div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-4">適正価格の維持</h3>
                    <p className="text-slate-600 leading-relaxed">
                ...
                <div className="flex gap-8 group">
                  <div className="text-4xl font-serif text-slate-200 group-hover:text-brand-blue transition-colors duration-500">03</div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-4">トラブル防止・仲裁</h3>
                    <p className="text-slate-600 leading-relaxed">
              ...
              <div className="mb-32">
                <p className="text-brand-blue font-black tracking-[0.4em] uppercase text-xs mb-6">Our Background</p>
                ...
                <p className="text-xl text-slate-600 leading-relaxed mb-20 max-w-3xl break-keep">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-20">
                  {[
                    ...
                    <div key={i} className={`p-10 rounded-[2.5rem] border ${stat.highlight ? 'bg-white shadow-xl border-brand-blue/20' : 'bg-slate-50 border-slate-100'}`}>
                      <p className={`text-[10px] font-black uppercase tracking-widest mb-2 ${stat.highlight ? 'text-brand-blue' : 'text-slate-400'}`}>{stat.label}</p>
                      <p className="text-4xl font-serif text-brand-blue mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
                  {[
                    ...
                    <div key={i} className={`group flex flex-col ${i === 1 ? 'md:mt-24' : i === 2 ? 'md:-mt-20' : ''}`}>
                      <div className="relative aspect-[4/3] overflow-hidden rounded-sm mb-10 shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-transform duration-700 group-hover:-translate-y-2">
                        <img 
                          src={item.image} 
                          alt={item.title} 
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-8 h-[1.5px] bg-slate-900"></div>
                        <h4 className="text-2xl font-bold text-slate-900 tracking-tight">{item.title}</h4>
                      </div>
              ...
              {/* 3 Promises Section */}
              <div className="mb-32">
                <p className="text-brand-blue font-black tracking-[0.4em] uppercase text-xs mb-6">Our 3 Promises</p>
                <h3 className="text-3xl font-serif text-slate-900 mb-16 break-keep">SMLが提供する3つの価値</h3>
                <div className="space-y-16">
                  <div className="flex gap-8">
                    <Globe className="w-10 h-10 text-brand-blue shrink-0" />
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-4">1. 可視化 (Visible)</h4>
                  ...
                  <div className="flex gap-8">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-4">2. 信頼 (Trusted)</h4>
                      <p className="text-slate-500 leading-relaxed">
                  ...
                  <div className="flex gap-8">
                    <TrendingUp className="w-10 h-10 text-brand-blue shrink-0" />
                    <div>
                      <h4 className="text-xl font-bold text-slate-900 mb-4">3. 最適 (Optimal)</h4>
                      <p className="text-slate-500 leading-relaxed">
              ...
              <div className="mb-32">
                <p className="text-brand-blue font-black tracking-[0.4em] uppercase text-xs mb-6">The Authority</p>
                <h2 className="text-4xl md:text-5xl font-serif text-slate-900 mb-16 tracking-tight leading-tight break-keep">
                  医師の選定と「MASTER CLASS」
                </h2>
          ...
          <section className="relative px-8 md:px-16 lg:px-24 py-40 bg-slate-900 text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <h2 className="text-4xl md:text-6xl font-serif mb-12 tracking-tight leading-tight break-keep">
                日本の医療を、<br />
                <span className="text-brand-blue">世界のスタンダードへ。</span>
              </h2>
              <p className="text-xl text-slate-400 leading-relaxed mb-16 font-light break-keep">
          ...
          <section className="px-8 md:px-16 lg:px-24 py-32 border-t border-slate-100">
            <div className="max-w-3xl">
              <div className="grid grid-cols-1 gap-8">
                ...
                <Link to="/for-agents" className="group p-12 bg-slate-50 rounded-[3rem] border border-slate-100 hover:border-brand-teal transition-all">
                  <p className="text-brand-teal font-black tracking-[0.3em] uppercase text-[10px] mb-4">Portal for Agents</p>
                  <h4 className="text-3xl font-serif text-slate-900 mb-6 group-hover:text-brand-teal transition-colors">For Agents</h4>
                  <p className="text-slate-500 mb-8">エージェント企業向けのご案内。ワンストップで日本最高峰の医療ネットワークへアクセス可能なハブ機能を提供します。</p>
